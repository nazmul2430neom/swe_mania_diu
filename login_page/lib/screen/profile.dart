          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                Row(
                  children: [
                    Icon(Icons.arrow_back,color: Colors.white70,size: 30,),
                    SizedBox(width: 25,),
                    Text("Login",style: TextStyle(color: Colors.white,fontSize: 24,fontWeight: FontWeight.w400),),
                  ],
                ),
                Padding(
                  padding: const EdgeInsets.only(top: 60,left: 1),
                  ...
                  child: TextFormField(
                    validator: (value) {
                     ...
                     decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(fontSize: 16,color: Colors.white70,fontWeight: FontWeight.w600),
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        padding: EdgeInsets.only(top: 11,left: 70,right: 12),
