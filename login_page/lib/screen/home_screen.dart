                  ...
                  children: [
                     Row(
                      ...
                      Padding(
                          ...
                          child: Text("Update Routine for Software Engineering Department of Summer 2023 ",style: GoogleFonts.lato(color: Colors.black87,fontSize: 18,fontWeight: FontWeight.w500),),
                        ),  
              ...
              child: Column(
                ...
                children: [
                   Row(
                    ...
                    Padding(
                        padding: EdgeInsets.only(left: 14,top: 10),
                        child: Text("DIU INTER-DEPARTMENTAL FOOTBALL TOURNAMENT 2023 ",style: GoogleFonts.lato(color: Colors.black87,fontSize: 17,fontWeight: FontWeight.w900),),
                      ), 

                  Padding(
                        padding: EdgeInsets.only(left: 14,top: 10),
                        child: Text("Greetings,Daffodil International University is going to organize Inter Department Football Tournament held from May 21,2023.  Students who are interested themself as a better football player are invited to take part in trail session with us ASAP.Participants should wear proper sports dress. ",style: GoogleFonts.lato(color: Colors.black87,fontSize: 18,fontWeight: FontWeight.w500),),
                      ),  
              ...
              child: Column(
                ...
                children: [
                   Row(
                    ...
                    Padding(
                        padding: EdgeInsets.only(left: 14,top: 10),
                        child: Text("WORKSHOP ON ROBOTICS AND ARTIFICIAL INTELLIGENCE 2023 ",style:GoogleFonts.lato(color: Colors.black87,fontSize: 17,fontWeight: FontWeight.w900)),
                      ), 

                  Padding(
                        padding: EdgeInsets.only(left: 14,top: 10),
                        child: Text("Greetings,Daffodil International University is going to organize an workshop on Robotics and Artificial Intelligence  held from 12 May,2023 at 2.30 pm.Students who are interested in Robotics and Artificial Intelligence are warmly invited to join the workshop and explore your ideas and to start a bright career in future. ",style:GoogleFonts.lato(color: Colors.black87,fontSize: 18,fontWeight: FontWeight.w500)),
                      ),  
